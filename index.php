...
<meta name="description" content="VNPTtoolbox is a Javascript and PHP app to look up DNS records such as SPF, MX, Whois, and more">
<meta property="og:description" content="VNPTtoolbox is a Javascript and PHP app to look up DNS records such as SPF, MX, Whois, and more" >
<meta name="keywords" content="Github, Open Source, MXToolbox, DNS, Blacklist, MX, PHP">
<meta name="author" content="Nguyen Bao Ngoc">

<title> VNPTtoolbox </title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div id="loading">
                <div class="info">
                <h3>About VNPT Toolbox</h3>
                <span>VNPT Toolbox was created to be an easy, free open source way for people to get information about their domain. Please click the link in the top right to let me know if you have any questions or suggestions for the app.</span>
                <br/>
                <br/>
                <br/>
                    <table>
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <footer>
                    <div class="row text-center">
                        <div class="col-md-12">
                            <p>Created by <a href="https://vnpt.com.vn">Phong Quan Tri He Thong TT.CNTT</a> | Contact: <a href="mailto:ngocnb1.hcm@vnpt.vn">ngocnb1.hcm@vnpt.vn</a></p>
                        </div>
                    </div>
                </footer>
            </div>
